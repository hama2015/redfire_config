...
public class SimpleFileFilter implements FileFilter { 
   ...
   */
	...
	public static void main(String args[]){
		String dir = "D://peakwork/peakFramework"; // directory of your choice 
//     //-----------不是递归的查找-----------------------------------
		File file = new File(dir); 
//		File[] files = file.listFiles(new SimpleFileFilter(SimpleFileFilter.DIRECTORY,"")); 
//		if(files!=null){
//		for(int f=0;f<files.length;f++){
//			System.out.println(files[f].getName());
//		}
//	}
	//	https://zhao-pc:8443/svn/redfire
	//--------------递归查找----------------------------------】
		System.out.println("--递归 查找 －－－－－－－－－－－");
		List<File> fileList=	SimpleFileFilter.deeplistFiles(file, new SimpleFileFilter(SimpleFileFilter.FILENAME,"entries"));	
		 if(fileList!=null){
				for(File fileObj:fileList){
					String text=FileTool.readFile(fileObj);
					if(text.indexOf("/svn/redfire")>0){
